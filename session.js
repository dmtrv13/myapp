...
exports.can = function(user) {
    ...
    res.view_books = user && user.id_role <= 3 ? true : false
    res.view_authors = user && user.id_role <= 3 ? true : false
    res.view_genres = user && user.id_role <= 3 ? true : false
    return res
}
